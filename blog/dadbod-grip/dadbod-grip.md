...
This is the Vim editing model applied to database work. Every motion works, and nothing installs outside Neovim: no Electron, no second window, and no copy-paste circuit.
