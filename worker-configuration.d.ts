/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 927f1836acf64348898a7b301acbe1e0)
// Runtime types generated with workerd@1.20260811.1 2026-08-14 nodejs_compat
interface __BaseEnv_Env {
	GEORGIE_ALLOWED_ORIGINS: "https://jorypestorious.com,http://127.0.0.1:4173,http://localhost:4173";
	GEORGIE_ROOM: DurableObjectNamespace<import("./worker/index").GeorgieRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "GeorgieRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GEORGIE_ALLOWED_ORIGINS">> {}
}
