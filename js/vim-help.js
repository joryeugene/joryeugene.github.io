(function() {
  var T = {
    ...
    ':teacher': [':teacher           Start or recall the applied Phalene Analytics project.',
                 ...
                 ':teacher score     Show session-only evidence, hints, corrections,',
                 '                   command strokes, observed skills, and flight time.',
                 ':teacher golf      After success, show an optional shorter Vim route.',
                 ':teacher reset     Confirm before restoring the six session-only files.',
                 '',
                 'Generated briefs are read-only. Ctrl-O returns to prepared work.',
                 'Briefs do not enter forward jump history.',
                 '',
