(function() {
  var T = {
    ...
    ':help':  [':help              Show general help.',
               ...
               '        :buffer :vsplit :tabedit text-objects macros marks',
  ...
  window.VIM_HELP_MAIN = function(VIM_VERSION) {
    return [
      ...
      '  gx          open external or site-local URL under cursor',
      ...
      '  Ctrl-w w    move between split windows   :only  keep one window',
