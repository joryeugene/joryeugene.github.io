(function() {
  var T = {
    ...
    ':teacher': [':teacher           Start or recall the applied Phalene Analytics project.',
                 ':teacher next      Open the first mission or advance ready work.',
                 ':teacher check     Name the first result the current mission still needs.',
                 ':teacher hint      Show one command hint without changing the work.',
                 ':teacher score     Session-only flight log.',
                 ':teacher golf      Shorter route after success.',
                 ':teacher reset     Confirm before restoring the six session-only files.',
                 '',
                 'Briefs are read-only. Ctrl-O returns to work without adding them',
                 'to forward jump history.',
                 '',
                 'Use :tutor to learn individual Vim basics. Use :teacher to apply',
                 'search, jumps, changes, registers, repeat, macros, completion, and',
                 'text objects while repairing a funny but realistic data incident.'],
  ...
  window.VIM_HELP_MAIN = function(VIM_VERSION) {
    return [
      ...
      '  :teacher    applied six-file Phalene Analytics project',
      ...
      'Ready for real work? Type :teacher for the applied project.',
      '',
