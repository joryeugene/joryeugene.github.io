(function() {
  var T = {
    ...
    'registers': ['"{register}       Use a register for the next yank, delete, change, or put.',
                  ...
                  '"_                Delete without changing registers or the clipboard.',
                   ...
                   'Yanks and deletes copy to the clipboard; "_ skips it. Cmd+V pastes.',
                   '',
    ...
    ':teacher': [':teacher           Start the core course or recall its current lesson.',
                 ':teacher map       Show lesson, review, and project progress.',
                 ':teacher lesson N  Open a selected lesson.',
                 ':teacher next      Open the next incomplete lesson or mission.',
                 ':teacher check     Name the first visible result still needed.',
                 ...
                 '',
                 'Briefs are read-only. Ctrl-O returns to work without adding them',
                 'to forward jump history.',
                 '',
  ...
  window.VIM_HELP_MAIN = function(VIM_VERSION) {
    return [
      ...
      '  "_ skips the clipboard. Cmd+V pastes.',
      '',
      'SCROLLING',
      ...
      '  :teacher    eight-lesson applied Vim course',
      '  :teacher project  six-file analytics incident project',
