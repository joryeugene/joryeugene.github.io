(function() {
  var T = {
    ...
    'registers': ['"{register}       Use a register for the next yank, delete, change, or put.',
                  '""                Unnamed register.',
                  '"0                Most recent yank.',
                  ...
                  '"_                Delete without changing registers or the clipboard.',
                   '',
                   'Registers keep character, line, or block shape.',
                   'Yanks and deletes copy to the clipboard; "_ skips it. Ctrl/Cmd+V pastes.',
                   '',
                   ':registers [names] Show non-empty registers, optionally filtered.',
                   ':display [names]   Alias for :registers.',
                   'Tabs show as ^I, newlines as ^J. Press u to return.'],
    ...
    'u':      ['u                  Undo last change.',
               '[count]u           Undo [count] complete changes.',
               '                   One Insert or Replace session is one change.'],
    ...
    '[[':     ['[[                 Jump backward to a section start ({ in column one).'],
    ']]':     [']]                 Jump forward to a section start ({ in column one).'],
    '[]':     ['[]                 Jump backward to a section end (} in column one).'],
    '][':     ['][                 Jump forward to a section end (} in column one).'],
    'g_':     ['g_                 Move to last non-blank character of the line.'],
    '|':      ['{count}|           Move to screen column {count}.'],
    '_':      ['{count}_           Move to first non-blank, {count}-1 lines down.'],
    'gx':     ['gx                 Open the URL under the cursor in a new browser tab.',
               '                   Supports https://, bare domains, and site paths such as /blog/.',
               '                   Use gf when you want to edit a file or article source here.'],
    'gf':     ['gf                 Open the file or document under the cursor here.',
               ':wincmd f          Open it in a vertical split without browser Ctrl-W.',
               ':tabedit file      Open a named file in a new tab page.',
               '',
               'Targets include loaded files, Teacher files, help topics,',
    ...
    ':buffers': [':buffers           List the files currently loaded in this editor.',
    ...
    ':vsplit': [':vsplit file       Open a loaded file beside the current file.',
                 ...
                 ':wincmd w          Move to the other split window.',
                 ':close             Close the current split window.',
                ':only              Keep the current window and close its peer.',
                '',
                'This web editor keeps one vertical split with two windows.'],
    ':tabedit': [':tabedit file      Open a loaded file in a new tab page.',
                 ':tabnext           Go to the next tab page.',
                 ':tabprevious       Go to the previous tab page.',
                 ':tabclose          Close the current tab page.',
                 ':tabonly           Keep only the current tab page.',
                 'gt / gT            Next / previous tab page.',
                 '{count}gt          Go to tab page {count}.',
                 '',
                 'Each tab page keeps its own window layout. The web editor',
                 'supports up to three tab pages.'],
    ...
    ':set':   [':set OPTION         Set an option. :set noOPTION to unset.',
               ...
               '',
               'Indentation:',
               '  :set et / noet    Insert spaces / a tab for Tab.',
               '  :set ts=4         Set inserted tab width.',
               '  :set sw=2         Set >> and << indentation width.',
               '  :set ai / noai    Copy indentation onto new lines.'],
    ':nohlsearch': [':nohlsearch   Clear search highlighting. Also :noh, :nohl.'],
    'Ctrl-r': ['CTRL-R             Redo in Normal mode (undo the undo).',
               'CTRL-R {register}  Insert a register in the : or / prompt.',
               '                   CTRL-R " uses the unnamed register.',
               '                   CTRL-R 0 uses the most recent yank.',
               '                   CTRL-R a uses named register a.'],
    'Ctrl-g': ['CTRL-G             Show file name, line count, and position.'],
    'Ctrl-o': ['[count] CTRL-O     Jump to an older position.',
               '[count] CTRL-I     Jump to a newer position.',
               '[count] Tab        Jump to a newer position in Normal/Visual mode.',
    ...
    ':Ex':    [':Ex                Browse article, Teacher, saved, and loaded files.',
               ':Explore           Same as :Ex.',
               ':Sexplore          Same as :Ex (no split in this editor).',
               ':Vexplore          Same as :Ex (no split in this editor).',
               '',
               'Navigate with j/k or search, then press gf or Enter.',
               'Use :wincmd f for a split or :tabedit file for a tab page.',
    ...
    ':snake': [':snake             Play Georgie Night Flight.',
               '                   Catch <*> moth-lights without hitting your trail.',
               '                   Move with h/j/k/l, WASD, or arrow keys.',
               '                   Space pauses, r restarts, Escape returns.',
               '                   The editor buffer stays untouched.'],
    ':moth':  [':moth              Enter the kinetic Phalene field.',
               '                   Hold h/j/k/l to pitch/yaw; q/e rolls.',
               '                   Chord keys for continuous three-axis rotation.',
               '                   Any key ripples; Enter flaps; Escape returns.',
               '                   Your editor buffer stays untouched.'],
    ...
    ':teacher': [':teacher           Start or resume the core course.',
                 ...
                 ':teacher retry     Restore a failed core lesson file.',
                 ':teacher hint      Advance through three hint levels.',
                 ':w                 Save and validate the active Teacher exercise.',
                 ':teacher review    Open the oldest completed lesson due for review.',
                 ':teacher project   Start or resume the applied incident project.',
                 ':teacher score     Show private session progress and observed skills.',
                 ':teacher golf      Show a shorter route after the result is correct.',
                 ':teacher export    Download progress without files or key history.',
                 ':teacher off       Hide the panel and pause Teacher. Keep progress.',
                 ':teacher reset     Confirm before clearing teacher progress and files.',
                 '',
                 'The Teacher panel stays at the top of the editor and shows one next action.',
                 'Use normal Vim commands to open, edit, and save the exercise.',
                 'A correct save advances once. An incorrect save shows one repair.',
                 'Optional map, score, and golf views are read-only. Ctrl-O returns',
                 'to your work without adding those views to forward jump history.',
                 '',
                 'The core course starts with safe edits and ends with macros and',
                 'multi-file work. Use :teacher project for the independent incident.'],
    ...
    'insert-index': ['Insert mode commands:',
                     ...
                     '  Ctrl/Cmd+V       Paste from system clipboard.'],
  ...
  T['Ctrl-w'] = ['CTRL-W w           Move to the other split window.',
                 ...
                 'CTRL-W gf          Open the target under the cursor in a tab page.',
                 '',
                 'Browsers may reserve CTRL-W to close a tab. Use :wincmd w or',
                 ':wincmd f when the browser shortcut wins.',
                 '',
                 'This web editor supports one vertical split, so each command',
                 'moves between the two visible windows.'];
  T['CTRL-W'] = T['Ctrl-w'];
  T['gt'] = T[':tabedit'];
  T['gT'] = T[':tabedit'];
  T[':tabnext'] = T[':tabedit'];
  T[':tabprevious'] = T[':tabedit'];
  T[':tabclose'] = T[':tabedit'];
  T[':tabonly'] = T[':tabedit'];
  T[':b'] = T[':buffer'];
  T[':vs'] = T[':vsplit'];
  T[':wincmd'] = T[':vsplit'];
  ...
  var TEACHER_TOPICS = [
    ...
    ':teacher map', ':teacher lesson N', ':teacher retry', ':teacher hint',
    ':teacher review', ':teacher project', ':teacher score', ':teacher golf',
    ':teacher export', ':teacher reset', ':teacher off'
  ];
  for (var tci = 0; tci < TEACHER_TOPICS.length; tci++) {
    T[TEACHER_TOPICS[tci]] = T[':teacher'];
  }
  ...
  T['ts'] = T['tabstop'];
  T['shiftwidth'] = [':set shiftwidth=N     Columns per > or < step. Default 2.',
                     '',
                     'Alias: :set sw=N',
                     '',
  ...
  window.VIM_HELP_MAIN = function(VIM_VERSION) {
    return [
      'PHALENE-VIM v' + VIM_VERSION + '                                        *help*',
      '',
      'MOVEMENT',
      ...
      '  | _ g_      column / first non-blank / last non-blank',
      '  gg G        buffer start / end',
      '  H M L       screen top / middle / bottom',
      '  { }         paragraph backward / forward',
      '  [[ ]]       previous / next section start ({ in column one)',
      '  [] ][       previous / next section end (} in column one)',
      '  %           matching bracket',
      ...
      '  :registers [names]  show registers; :display is an alias',
      '  Ctrl-r {register} inserts a register in the : or / prompt',
      '  Registers keep char, line, or block shape and copy to the clipboard.',
      '  "_ skips the clipboard. Ctrl/Cmd+V pastes.',
      '',
      'SCROLLING',
      '  Ctrl-f      page down         Ctrl-b  page up',
      '  Ctrl-d      half page down    Ctrl-u  half page up',
      '  Ctrl-e      one line down      Ctrl-y  one line up',
      ...
      '  :teacher    twelve-lesson applied Vim course',
      '  :teacher project  eight-mission analytics incident project',
      '  :teacher off      pause Teacher and keep progress',
      '  :moth       kinetic Phalene field',
      '  :snake      play Georgie Night Flight with hjkl',
      '  :agents     animated agent aquarium',
      '  Ctrl-p      searchable command palette',
      '  :help topic help on any command (e.g. :help w, :help :s)',
      '',
      'Yank copies to system clipboard. Ctrl/Cmd+V pastes.',
      'Tab / Shift+Tab cycle completions in command mode.',
      'Preferences saved to localStorage.',
      '',
      'Type :teacher to learn Vim through real edits.',
      'Type :teacher project to open the independent incident project.',
      '',
