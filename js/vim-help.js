(function() {
  var T = {
    ...
    ':teacher': [':teacher           Start or recall the applied Vim project.',
                 ...
                 ':teacher score     Session-only progress and skill summary.',
                 ...
                 'text objects while repairing a production-data incident.'],
  ...
  window.VIM_HELP_MAIN = function(VIM_VERSION) {
    return [
      ...
      '  :teacher    applied six-file production-data project',
