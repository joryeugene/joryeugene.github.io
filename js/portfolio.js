  ...
  const processCases = {
    'dadbod-grip': {
      ...
      layers: {
        ...
        tests: '<h2>Run the workbench on both supported Neovim targets.</h2><p>The linked CI run passes 74 spec files and 1,761 assertions on Neovim stable and 0.10 with DuckDB installed. PostgreSQL and MySQL integration specs remain skipped, so the run does not prove every database and CLI combination.</p><div class="proof-strip"><span>74 spec files</span><span>1,761 assertions</span><span>Two Neovim targets</span></div><p class="proof-line"><a href="https://github.com/joryeugene/dadbod-grip.nvim/actions/runs/30663015056">Inspect the passing run</a> · <a href="/blog/dadbod-grip/">Read the build story</a></p>',
